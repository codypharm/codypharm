import { Download, Bot, MapPin, ChevronDown } from "lucide-react";
    ...
    >
      ...
      <div className="relative z-10 container mx-auto px-6 py-24 flex flex-col lg:flex-row items-center gap-16 max-w-6xl">
        ...
        <div className="flex-1 text-center lg:text-left animate-fade-in-up">
          <span className="block uppercase text-accent tracking-widest font-bold text-sm mb-4">
            {PROFILE.titleShort}
          </span>
          ...
          <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
            <a
              href="/cv.pdf"
              download
              className="flex items-center gap-2 border border-accent text-accent hover:bg-accent/10 font-medium px-5 py-2.5 rounded-lg transition-colors duration-200 uppercase tracking-wide text-sm"
            >
            ...
            <a
              ...
              className="flex items-center gap-2 border border-white/20 hover:border-white/40 text-white/70 hover:text-white font-medium px-5 py-2.5 rounded-lg transition-all duration-200 uppercase tracking-wide text-sm"
            >
        ...
        <div className="flex-shrink-0 w-full max-w-sm lg:max-w-md animate-fade-in-up" style={{ animationDelay: "0.2s" }}>
          <div className="bg-navy-light border border-accent/30 rounded-2xl shadow-[0_0_30px_rgba(77,218,218,0.15)] overflow-hidden">
            {/* Terminal title bar */}
